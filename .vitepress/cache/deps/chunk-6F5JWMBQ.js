    ...
    promise.value = new Promise((resolve, reject) => {
      try {
        ...
        if (_target == null) {
          ...
          resolve(
            window.btoa(String.fromCharCode(...new Uint8Array(_target)))
          )
  ...
  function init() {
    if (window2) {
      const onDeviceMotion = createFilterWrapper(eventFilter, (event) => {
        ...
        rotationRate.value = {
          alpha:
            ((_g = event.rotationRate) == null ? void 0 : _g.alpha) ||
            null,
          beta:
  ...
  if (isClient) {
    ...
    const getFiles = (event) => {
      ...
      const list = Array.from(
        (_b2 = (_a2 = event.dataTransfer) == null ? void 0 : _a2.files) !=
          null
          ? _b2
          : []
      )
    ...
    const handleDragEvent = (event, eventType) => {
      ...
      isValid =
        (_b2 =
          dataTransferItemList && checkValidity(dataTransferItemList)) !=
        null
          ? _b2
          : false
  ...
  useEventListener(
    ...
    () => {
      ...
      return (_focused.value =
        (_c =
          (_b =
            (_a = targetElement.value) == null ? void 0 : _a.matches) ==
          null
            ? void 0
  ...
  const isElementFullScreen = () => {
    if (fullscreenEnabled.value) {
      if (document2 && document2[fullscreenEnabled.value] != null) {
        ...
        if (
          (target2 == null ? void 0 : target2[fullscreenEnabled.value]) !=
          null
        ) {
...
function useTextDirection(options = {}) {
  ...
  function getValue2() {
    ...
    return (_b =
      (_a =
        document2 == null ? void 0 : document2.querySelector(selector)) ==
      null
        ? void 0
...
function useTextSelection(options = {}) {
  ...
  const text = computed(() => {
    var _a, _b
    return (_b =
      (_a = selection.value) == null ? void 0 : _a.toString()) != null
      ? _b
      : ''
  })
...
function useVModel(props, key, emit, options = {}) {
  ...
  const _emit =
    ...
    ((_a = vm == null ? void 0 : vm.$emit) == null
      ...
      : _a.bind(vm)) ||
    ((_c =
      (_b = vm == null ? void 0 : vm.proxy) == null ? void 0 : _b.$emit) ==
    null
      ? void 0
...
//# sourceMappingURL=chunk-6F5JWMBQ.js.map
